...
class DataIngestion:
    ...
    def _get_csv_path(self):
        """
        Get the path to the CSV file located inside "data" folder.
        """ 
    ...
    def transform_data(self):
        """
        Tranform product data into list of LangChain Document objects.
        """
        product_list = []
    ...
    def run_pipeline(self):
        ...
        query = "Can you tell me a low budget iphone?"
